// Cart Info Cache V1 by 51mayday
...
_print_data_gt(gametick) -> (
    if(global_last_tick - gametick >= global_timeout, 
        ...
        print(player(), format('eb [Summon all carts]', '^w Summon all carts stored for this gametick', '!/script in cart_info_cache_v1_2_dev invoke summon_all ' + gametick););
        print(player(), format('rb [Kill all carts]', '^w Kill all carts', '!/script in cart_info_cache_v1_2_dev invoke kill_all'););
